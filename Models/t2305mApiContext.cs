...
namespace DMAWS_T2305M_TuanAnh.Models
{
    public class t2305mApiContext : DbContext
    {
        public t2305mApiContext(DbContextOptions<t2305mApiContext> options) : base(options)
        {
        }
